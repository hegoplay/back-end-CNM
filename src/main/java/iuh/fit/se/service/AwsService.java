...
//        item.put("phone", AttributeValue.builder().s(request.getPhone()).build());
//        item.put("name", AttributeValue.builder().s(request.getName()).build());
//        item.put("dob", AttributeValue.builder().s(request.getDob()).build());
//        item.put("gender", AttributeValue.builder().s(request.getGender()).build());
//        item.put("avatar", AttributeValue.builder().s(avatarUrl).build());
//
